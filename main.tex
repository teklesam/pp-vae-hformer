...
The Contrast-to-Noise Ratio (CNR) quantifies the clinical impact of noise: the Rose criterion requires a CNR of at least 5.0 for reliable lesion detection \cite{rose_sensitivity_1948}. As dose falls, CNR drops below this threshold for low-contrast findings such as early pneumonic consolidation or a fine pleural line, increasing false-negative and false-positive rates \cite{bhadra_hallucinations_2021}. Post-acquisition computational denoising can recover diagnostic quality without additional radiation exposure.
