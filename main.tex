...
(DSBs), in which both strands of the DNA helix are severed in close spatial proximity, represent
...
\begin{table}[H]
  ...
  \small
  \begin{tabularx}{\linewidth}{p{2.2cm} p{2.5cm} p{1.4cm} p{1.4cm} p{1.2cm} p{3.2cm} p{2.8cm} p{1.0cm} p{1.0cm}}
    \toprule
    \textbf{Method Class} &
    \textbf{Key Examples} &
    \textbf{Domain} &
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    harr/.style={->, thick, red!60, dashed},
  ]
