...
\textbf{Gap 3: Absence of calibrated pixel-level uncertainty.} Deterministic models provide no confidence signal. VAE-based uncertainty has not been evaluated for paediatric CXR with calibration metrics that establish clinical trustworthiness \cite{kendall_what_2017}.
