...
\midrule
\multicolumn{5}{l}{\textit{PP-VAE-Hformer (proposed)}} \\
Arm A (L2) -- all arms share architecture & 1,649,729 & $\approx$9--10 & --- & VAE + dual head \\
\midrule
\multicolumn{5}{l}{\textit{Retrained KAIR baselines}} \\
DnCNN \cite{zhang_beyond_2017}  & 668,224  & $\approx$14 & --- & residual CNN \\
IRCNN \cite{zhang_learning_2017}& 187,584  & $\approx$14 & --- & modular PnP \\
FFDNet \cite{zhang_ffdnet_2018} & 486,080  & $\approx$14 & --- & $\sigma$-conditioned CNN \\
DRUNet \cite{zhang_drunet_2021} & 32,640,513 & $\approx$14 & --- & U-Net, $\sigma$-cond. \\
SwinIR \cite{liang_swinir_2021}$^\dagger$ & 11,490,945 & $\approx$35 & --- & Swin Transformer \\
\midrule
\multicolumn{5}{l}{\textit{Extended SOTA baselines}} \\
NAFNet \cite{chen_nafnet_2022}  & 115,980,609 & $\approx$8 & --- & simple gate, AMP \\
SCUNet \cite{zhang_scunet_2023} & 57,043,457  & $\approx$45 & --- & Swin-Conv hybrid, no AMP \\
\bottomrule
\multicolumn{5}{p{0.94\linewidth}}{\footnotesize
  Inference latency (ms/image) measured on A100 with 200 forward passes after 20 warmup
  passes; will be populated from benchmarking results.
  Parameter counts verified from loaded model state dicts at training time.} \\
\end{tabular}
\end{table}
