...
Q & Charbonnier ($\mathcal{L}_{\mathrm{Charb}}$) & --- & $34.535$ {[--,--]}$^\ddagger$ & $0.9266$ & $0.9731$ & ---$^\ddagger$ \\
R & Curriculum FT: L1\,+\,SSIM\,+\,FFL           & --- & $34.539$ {[--,--]}$^\ddagger$ & $0.9269$ & $0.9727$ & ---$^\ddagger$ \\
S & Curriculum FT: NLL\,+\,SSIM\,+\,FFL          & --- & $34.609$ {[--,--]}$^\ddagger$ & $0.9265$ & $0.9731$ & ---$^\ddagger$ \\
\midrule
...
\item[$\ddagger$] Arms~Q, R, S: bootstrap 95\% CIs and LPIPS pending completion of full evaluation pipeline run. PSNR and SSIM are point estimates from the 624-image test set.
\end{tablenotes}
\end{threeparttable}
\end{sidewaystable}
