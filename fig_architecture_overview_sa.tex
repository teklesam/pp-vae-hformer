...
% ── Output thumbnails ────────────────────────────────────────────────
% mu: clean ground truth of the same patient (arch_input_clean.png = same patient as noisy input)
% aleatoric, epistemic: regenerate from arch_input_noisy.png on CSD3 for same-patient match
\node[ovImg] (outmu) at (4.5,10.2)
  {\includegraphics[width=1.1cm,height=1.1cm,keepaspectratio]%
    {figures/arch/arch_input_clean.png}};
